    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
      {dataOverview.map((item, index) => (
        <div class="bg-white  rounded-2xl p-[3vh] space-y-3 shadow-md">
          <div
            class="bg-gray-100 rounded-full p-[3vh] w-10 h-10 flex items-center justify-center "
          ...
          <div class="flex flex-col  space-y-0">
            <h3 class="text-[2vh] font-inter font-semibold text-gray-500">
              {item.title}
            </h3>
            <div class="flex gap-2 items-center">
              ...
              <span class="text-[2vh] font-inter font-semibold text-black">
                /
              </span>
              <h3 class="text-[2vh] font-inter font-semibold text-black">
                {item.subValue}
              </h3>
            </div>
