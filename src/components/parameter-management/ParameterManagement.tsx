  ...
  const tabs: Tab[] = [
    {
      ...
      icon: (
        ...
        >
          <path
            fill="none"
            stroke={activeTab() === "sms-template" ? "#2F69F3" : "#989898"}
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill="#989898"
            stroke={activeTab() === "provider" ? "#2F69F3" : "#989898"}
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <g
            fill="none"
            stroke={activeTab() === "costs" ? "#2F69F3" : "#989898"}
            stroke-linecap="round"
            stroke-width="1.5"
          >
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <g
            fill="none"
            stroke={activeTab() === "country" ? "#2F69F3" : "#989898"}
            stroke-linecap="round"
            stroke-linejoin="round"
            stroke-width="1.5"
            color="#989898"
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill="#989898"
            stroke={activeTab() === "application" ? "#2F69F3" : "#989898"}
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill="#989898"
            stroke={activeTab() === "gateways" ? "#2F69F3" : "#989898"}
