...
const Sidebar: Component<{
  ...
  return (
    <aside
      class={`fixed inset-y-0 left-0 z-30 bg-white dark:bg-gray-800 transform transition-all duration-300 ease-in-out lg:translate-x-0 ${props.isMobileOpen || props.isOpen
          ? "translate-x-0"
          : "-translate-x-full"
