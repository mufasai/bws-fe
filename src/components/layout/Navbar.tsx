...
const Navbar: Component<{ onToggleSidebar: () => void; isSidebarOpen: boolean }> = (props) => {
  ...
  const [title, setTitle] = createSignal(" User Dashboard");

  const location = useLocation();

  onMount(() => {
    setTitle(location.pathname.split('/').pop() || " User Dashboard");
  });
  ...
  return (
    <>
      <nav class=" px-5 py-2 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 w-full h-100 bg-[#f3f4f8] backdrop-blur-md">
