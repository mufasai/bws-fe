  ...
  return (
    <div class="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div class="flex-1 flex flex-col md:ml-[250px]" style={{
        'margin-left': window.innerWidth >= 768 ? (isSidebarOpen() ? '15vw' : '70px') : '0',
        'transition': 'margin-left 300ms'
      }}>
        <div class="fixed top-0 right-0 z-10 w-full md:w-auto" style={{
          'left': window.innerWidth >= 768 ? (isSidebarOpen() ? '15vw' : '70px') : '0',
  ...
  return (
    <div class="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div class="flex-1 flex flex-col md:ml-[250px]" style={{
        ...
        <main class="flex-1 p-4 overflow-auto mt-[53px] bg-[#ECEFF3]">
          {props.children}
        </main>
      </div>
    </div>
