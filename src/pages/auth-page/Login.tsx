...
import { LoginAPI, ForgotPasswordAPI, ResetPasswordAPI } from "../../services/service";
...
const showResetPasswordPopup = async (email: string) => {
  try {
    const { value: formValues } = await Swal.fire({
      ...
      showCancelButton: true,
      preConfirm: async () => {
        const verificationCode = (document.getElementById('swal-input1') as HTMLInputElement).value;
      ...
      <div class="w-full lg:w-1/2 justify-center p-8 mb-10 mt-5 lg:px-20 lg:py-1">
        <div class="max-w-md w-full mx-auto">
          ...
          <div class="flex justify-center mb-6">
            <img src="/Logo.png" alt="BWS Logo" class="h-11 w-auto" style="margin-left: 310px;" />
          </div>
          <div class="bg-white p-6 rounded-2xl shadow-lg mt-8">
            <div class="mb-8">
              <h1 class="text-2xl font-bold text-gray-800 mb-2">Login</h1>
              <p class="text-gray-600 text-1xl">Login with your personal account</p>
            </div>
