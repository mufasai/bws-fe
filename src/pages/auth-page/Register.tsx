...
const Register: Component = () => {
  ...
  const handleTokenVerification = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:8080/api/auth/verify_email?token=${encodeURIComponent(token())}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    <div class="min-h-screen bg-white flex"
          ...
          <div class="bg-white p-6 rounded-2xl shadow-xl">
            ...
            <form onSubmit={handleSubmit} class="space-y-1">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-3 ">
                ...
                <div>
                  <label class="text-xs font-medium text-gray-700 block mb-1">Date of Birth</label>
                  <input
                    type="date"
                    name="dob"
                    required
              ...
              <div>
                <label class="text-xs font-medium text-gray-700 block mb-1">Email Address</label>
                <input
                  type="email"
                  name="email"
                  required
      ...
      {showPopup() && (
          <div
            class="absolute inset-0 flex items-center justify-center bg-gray-500 bg-opacity-75"
          >
