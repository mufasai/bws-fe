...
import { DeleteUsersManagementAPI, getAllUserManagement } from "../services/service";
    ...
    <>
      <div class="min-h-screen space-y-0 space-x-6 flex flex-col">
        ...
        <div class="font-inter bg-white  rounded-2xl shadow-sm  m-6 w-[97%] h-full">
          ...
          {/* Modal */}
          {showAddModal() && (
            <div class="fixed inset-0 z-50 flex items-center justify-center w-full h-screen bg-black bg-opacity-50" aria-hidden="true">
                  ...
                  <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div class="mt-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("phone_number", e.currentTarget.value)
                        }
                      />
                    </div>
                    <div class="mt-4">
                    ...
                    <div class="mt-4">
                      <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Country Code</label>
                      <input
                        type="text"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        value={form()?.country_code || ""}
                        onChange={(e) =>
                          handleInputChange("country_code", e.currentTarget.value)
                        }
                      />
                    </div>
                    <div class="mt-4">
                      <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Verification Status</label>
                      <select
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        value={form()?.verification_status || ""}
                        onChange={(e) =>
                          handleInputChange("verification_status", e.currentTarget.value)
                        }
                      >
