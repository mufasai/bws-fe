...
import { DeleteUsersManagementAPI } from '../services/service';
...
export default function ProjectPage() {
    ...
    const summaryInfor: { title: string, value: string, description: string, change: string, trend: string, color: string, bgColor: string, icon: any }[] = [
        {
            title: "Total User",
            value: "1923",
            // subValue: "Rp. 50 M",
                            ...
                            <div class="bg-white rounded-2xl p-6 space-y-3 flex flex-row space-x-3 justify-between">
                                <div class="flex flex-col space-y-3 my-auto">
                                    <div class ="flex items-center space-x-3 ">
                                        <div class="bg-gray-100 rounded-full p-[3vh] w-2 h-10 flex items-center justify-center flex flex row" style={{ background: item.bgColor }}>
                                            <div class="text-white flex items-center justify-center" style={{color: item.color}}>
                                                {item.icon}
                                            </div>
                                        </div>
                                        <h3 class="text-[2vh] font-inter font-medium text-[#171717]">{item.title}</h3>
                                    </div>
                                    ...
                                    <div class="flex gap-3 items-left font-inter flex-col my-auto">
                                        <div class="flex flex-row items-center gap-3">
                                            ...
                                            fallback={
                                                    ...
                                                    <path d="M1 36.5L10.8087 23.2745L16.5304 28.1471L27.9739 13.5294L35.7391 21.1863L48 1" stroke="#11D600"/>
                                                    <path d="M10.8087 23.2745L1 36.5H48V1L35.7391 21.1863L27.9739 13.5294L16.5304 28.1471L10.8087 23.2745Z" fill="url(#paint0_linear_60_460)"/>
                                                    <defs>
                                                    <linearGradient id="paint0_linear_60_460" x1="24.5" y1="1" x2="24.5" y2="36.5" gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="#11D600" stop-opacity="0.5"/>
                                                    <stop offset="1" stop-color="#11D600" stop-opacity="0.01"/>
                                                    </linearGradient>
                                                    </defs>
                                                    </svg>
                                            ...
                                            <p class="text-[2vh] font-inter text-black">{item.change}</p>
                                        </div>
                    ...
                    <div class='space-y-4 p-6'>
                        <div class='flex items-center justify-between'>
                            <div class='flex items-center gap-2'>
                                <div>
                                    <div class='flex items-center gap-2'>
                                        <h1 class='text-md font-semibold font-inter text-gray-900'>All Users</h1>
                                        <span class='text-[1.5vh] font-inter text-[#0070FF] bg-[#EBF5FF] px-2 py-1 rounded-full font-inter'>Label Text</span>
                                    </div>
                                    <p class='text-sm font-inter text-gray-500 mt-2'>displays a complete list of all users </p>
                                </div>
                            </div>
                        ...
                        <div class='flex items-center justify-between'>
                            <div class='flex items-center gap-3'>
                                ...
                                <div class='flex items-center gap-2 p-1 bg-[#F2F2F2] rounded-lg'>
                                    {statusTabs.map((tab) => (
                                        <button
                                            class={`px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 ease-in-out relative  ${activeStatusTab() === tab
                                                ? 'text-gray-900 bg-white shadow-sm'
                                                : 'text-gray-600 hover:text-gray-900'
                                                }`}
